...
class TestBasket:
    def test_add_product(self, product, user_basket):
        ...
        assert user_basket._basket == basket_data  # TODO(Aleksei Churkin): Change access method.  # noqa: SLF001
    ...
    def test_delete_product(self, product, user_basket):
        ...
        assert user_basket._basket == {}  # TODO(Aleksei Churkin): Change access method.  # noqa: SLF001
