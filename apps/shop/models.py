...
class Catalog(models.Model):
    ...
    upper_catalog = models.ForeignKey('self',
    ...
    def clean(self):
        ...
        while catalog.upper_catalog:
            ...
            if nesting_level > 1:
                raise ValidationError({'upper_catalog': _(f'The maximum nesting level is 1')})
...
class Product(models.Model):
    ...
    specification = models.FileField(upload_to='products/specifications',
                                     default=None,
                                     blank=True,
                                     null=True,
                                     ...
                                     validators=[FileExtensionValidator(
                                         ...
                                         message=_("Can only be saved in 'pdf' format"))])
